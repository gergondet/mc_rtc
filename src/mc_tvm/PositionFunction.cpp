...
PositionFunction::PositionFunction(mc_rbdyn::RobotFrame & frame) : tvm::function::abstract::Function(3), frame_(frame)
{
  reset();
  // clang-format off
  ...
  addInputDependency<PositionFunction>(Update::Value, frame_, mc_rbdyn::RobotFrame::Output::Position);
  addInputDependency<PositionFunction>(Update::Velocity, frame_, mc_rbdyn::RobotFrame::Output::Velocity);
  addInputDependency<PositionFunction>(Update::Jacobian, frame_, mc_rbdyn::RobotFrame::Output::Jacobian);
