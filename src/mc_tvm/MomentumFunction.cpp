...
MomentumFunction::MomentumFunction(mc_rbdyn::RobotPtr robot)
: tvm::function::abstract::Function(6), momentumAlgo_(robot->momentumAlgo())
{
  reset();
  // clang-format off
  ...
  addInputDependency<MomentumFunction>(Update::Value, momentumAlgo_, mc_rbdyn::Momentum::Output::Momentum);
  addInputDependency<MomentumFunction>(Update::Jacobian, momentumAlgo_, mc_rbdyn::Momentum::Output::Jacobian);
  addInputDependency<MomentumFunction>(Update::NormalAcceleration, momentumAlgo_,
                                       mc_rbdyn::Momentum::Output::NormalAcceleration);
  addInputDependency<MomentumFunction>(Update::JDot, momentumAlgo_, mc_rbdyn::Momentum::Output::JDot);
}
